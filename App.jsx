...
const gemsData = [
  ...
  { name: 'Luang Prabang', country: 'Laos', continent: 'Asia', desc: 'Buddhist monks in saffron robes, dawn alms-giving rituals, and golden Mekong sunsets', bestTime: 'November – March', image: 'https://images.unsplash.com/photo-1583531172005-814194ee2831?w=600&h=800&fit=crop&q=80' },
  { name: 'Matera', country: 'Italy', continent: 'Europe', desc: '2,000-year-old cave dwellings carved into the Basilicata hillside — a living fossil city', bestTime: 'April – October', image: 'https://images.unsplash.com/photo-1568797629042-2e3554481970?w=600&h=800&fit=crop&q=80' },
  { name: 'Chefchaouen', country: 'Morocco', continent: 'Africa', desc: 'The Blue City — every wall, staircase, and doorway painted in shades of cerulean and cobalt', bestTime: 'March – May', image: 'https://images.unsplash.com/photo-1553244886-a5e1e20449f3?w=600&h=800&fit=crop&q=80' },
  { name: 'Faroe Islands', country: 'Denmark', continent: 'Europe', desc: 'Dramatic sea cliffs, puffin colonies, grass-roofed villages, and absolute solitude', bestTime: 'June – August', image: 'https://images.unsplash.com/photo-1526080652727-5b77f74eacd2?w=600&h=800&fit=crop&q=80' },
