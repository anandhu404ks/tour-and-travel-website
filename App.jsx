...
const culinaryData = [
  { dish: 'Street Pad Thai', city: 'Bangkok', country: 'Thailand', flag: '🇹🇭', desc: 'Wok-tossed rice noodles at Thip Samai, open since 1966 — a national treasure on a plate', category: 'Street Food', tagClass: 'tag-street-food', foodTour: true, image: 'https://images.unsplash.com/photo-1559314809-0d155014e29e?w=600&h=500&fit=crop&q=80', guideUrl: 'https://www.tripadvisor.com/Search?q=Thip+Samai+Pad+Thai+Bangkok' },
  ...
  { dish: 'Moroccan Tagine', city: 'Marrakech', country: 'Morocco', flag: '🇲🇦', desc: 'Slow-cooked lamb with preserved lemon and saffron in a hand-crafted clay pot', category: 'Traditional', tagClass: 'tag-traditional', foodTour: false, image: 'https://images.unsplash.com/photo-1541518763669-27fef04b14ea?w=600&h=500&fit=crop&q=80', guideUrl: 'https://www.tripadvisor.com/Search?q=Best+Tagine+Marrakech' },
  { dish: 'Sushi Omakase', city: 'Tokyo', country: 'Japan', flag: '🇯🇵', desc: "Chef's seasonal selection at Tsukiji Outer Market — artistry at dawn", category: 'Fine Dining', tagClass: 'tag-fine-dining', foodTour: true, image: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=600&h=500&fit=crop&q=80', guideUrl: 'https://www.tripadvisor.com/Search?q=Sushi+Omakase+Tsukiji+Outer+Market+Tokyo' },
  { dish: 'Arancini & Cannoli', city: 'Palermo, Sicily', country: 'Italy', flag: '🇮🇹', desc: "Crispy risotto balls and cream-filled pastries at Ballarò market — street food perfection", category: 'Market', tagClass: 'tag-market', foodTour: true, image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=600&h=500&fit=crop&q=80', guideUrl: 'https://www.tripadvisor.com/Search?q=Ballaro+Market+Street+Food+Palermo' },
  { dish: 'Masala Dosa', city: 'Chennai', country: 'India', flag: '🇮🇳', desc: 'Crispy fermented crepe stuffed with spiced potato, served with sambar at Murugan Idli Shop', category: 'Street Food', tagClass: 'tag-street-food', foodTour: false, image: 'https://images.unsplash.com/photo-1630383249896-424e482df921?w=600&h=500&fit=crop&q=80', guideUrl: 'https://www.tripadvisor.com/Search?q=Murugan+Idli+Shop+Chennai' },
];
